...
export const categories = [
  { id: "fruits",     label: "Trái Cây Tươi",          emoji: "🍊", icon: "/icons/TraiCayTuoi.ico",    color: "#fff3cd" },
  { id: "vegetables", label: "Rau Củ Quả",              emoji: "🥦", icon: "/icons/RauCuQua.ico",       color: "#d8f3dc" },
  { id: "grains",     label: "Gạo & Ngũ Cốc",          emoji: "🌾", icon: "/icons/GaoVaNguCoc.ico",    color: "#fde8c8" },
  { id: "herbs",      label: "Gia Vị & Thảo Mộc",      emoji: "🌿", icon: "/icons/GiaVi.ico",          color: "#e0f2e9" },
  { id: "dried",      label: "Đặc Sản Khô",             emoji: "🧅", icon: "/icons/DacSanKho.ico",      color: "#f5e6d3" },
];
