              ...
              <div className="checkout-card">
                ...
                <div className="payment-options">
                  {[
                    ...
                    <label
                      ...
                      className={
                        "payment-option" +
                        (form.payment === opt.value ? " selected" : "")
                      }
                    >
                      <input
                        type="radio"
                ...
                {form.payment === "bank" && (
                  <div className="bank-info">
                    ...
                    <p>
                      <b>Chủ tài khoản:</b> CÔNG TY TNHH AGRISMART
                    </p>
                    <p>
                      <b>Số tiền:</b> {fmt(grandTotal)}
                    </p>
                    <p>
                      <b>Nội dung chuyển khoản:</b> Số điện thoại của bạn
                    </p>
                  </div>
                )}
                <div className="checkout-btn-row">
            ...
            {step === 3 && (
              <div className="checkout-card checkout-success">
                ...
                <p className="success-msg">
                  Cảm ơn <strong>{form.name || "quý khách"}</strong>! Nông sản
                  tươi của bạn đang trên đường đến.
                  <br />
                  Chúng tôi sẽ gọi cho bạn tại số{" "}
                  <strong>{form.phone || "số điện thoại của bạn"}</strong> để
                  xác nhận.
                </p>
                <div className="success-details">
                  <div>
                    <span>📦</span>
                    <p>Mã đơn #RT-{Date.now().toString().slice(-6)}</p>
                  </div>
                  <div>
                    <span>📍</span>
                    <p>
                      {form.address || "Địa chỉ của bạn"}, {form.city}
                    </p>
                  </div>
                  <div>
                    <span>⏰</span>
                    <p>Dự kiến giao hàng: 2–4 giờ</p>
                  </div>
                  <div>
                    <span>💳</span>
                    <p>
            ...
            <aside className="checkout-summary">
              ...
              <div className="checkout-summary__line">
                ...
                <span className={delivery === 0 ? "free-delivery" : ""}>
                  {delivery === 0 ? "MIỄN PHÍ 🎉" : fmt(delivery)}
                </span>
              </div>
              {delivery > 0 && (
