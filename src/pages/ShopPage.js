...
export default function ShopPage() {
  ...
  return (
    <main className="shop-page">
      {/* Cover */}
      <div className="shop-cover" style={{ backgroundImage: `url(${shop.coverImage})` }}>
      ...
      <div className="container">
        ...
        <div className="shop-header">
          <div className="shop-avatar-wrap">
            ...
            {shop.verified && <span className="shop-verified-badge" title="Gian hàng đã xác minh">✓</span>}
          </div>
          ...
          <div className="shop-header__info">
            ...
            <p className="shop-owner">🧑‍🌾 Chủ hàng: <strong>{shop.owner}</strong></p>
            ...
            <div className="shop-stats-row">
              ...
              <div className="shop-stat">
                <span className="shop-stat__val">{shop.totalReviews.toLocaleString("vi-VN")}</span>
                <span className="shop-stat__label">Lượt đánh giá</span>
              </div>
              <div className="shop-stat-divider" />
              <div className="shop-stat">
                <span className="shop-stat__val">{shop.totalSales.toLocaleString("vi-VN")}</span>
          ...
          <div className="shop-header__actions">
            <a href={shop.socialLinks.zalo} className="btn btn-primary shop-contact-btn">
              💬 Nhắn tin
            </a>
            <a href={shop.socialLinks.facebook} className="btn btn-outline shop-follow-btn">
              ❤️ Theo dõi
            </a>
          </div>
        </div>
        ...
        {shop.certifications.length > 0 && (
          <div className="shop-certs">
            {shop.certifications.map(cert => (
              <span key={cert} className="shop-cert-badge">🏅 {cert}</span>
            ))}
            <span className="shop-cert-badge">📅 Hoạt động từ {shop.established}</span>
          </div>
        )}
        ...
        <div className="shop-tabs">
          <div className="shop-tabs__nav">
            ...
            <button
              className={"shop-tab-btn" + (activeTab === "about" ? " active" : "")}
              ...
              <div className="shop-products-section">
                <div className="shop-products-header">
                  <p className="shop-products-meta">
                    <span className="shop-products-meta__count">{shopProducts.length} sản phẩm</span>
                    &nbsp;·&nbsp;
                    <span className="shop-products-meta__stock">{inStockCount} còn hàng</span>
                  </p>
                </div>
