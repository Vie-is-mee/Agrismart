...
function AddProductModal({ onClose, onAdd }) {
  ...
  const [origin, setOrigin] = useState("Tỉnh Lâm Đồng");
  const [price, setPrice] = useState("");
  const [unit, setUnit] = useState("kg");
  const [stockQty, setStockQty] = useState("50");
  const [inStock, setInStock] = useState(true);
  const [description, setDescription] = useState("");
  const [imagePreview, setImagePreview] = useState("https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&q=80"); // default veggie image
  const [imageFile, setImageFile] = useState(null);
  const fileRef = useRef(null);
  ...
  const categoryOptions = [
    { id: "fruits", name: "🍊 Trái Cây Tươi" },
    { id: "vegetables", name: "🥦 Rau Củ Quả" },
    { id: "grains", name: "🌾 Gạo & Ngũ Cốc" },
    { id: "herbs", name: "🌿 Gia Vị & Thảo Mộc" },
    { id: "dried", name: "🧅 Đặc Sản Khô" },
  ];
        ...
        <div className="modal-body">
          ...
          <div className="edit-grid-2">
            ...
            <div className="edit-field edit-field--span2">
              ...
              <input
                ...
                value={name}
                onChange={(e) => setName(e.target.value)}
                placeholder="Ví dụ: Rau Cải Ngọt Hữu Cơ, Mật Ong Hoa Nhãn..."
                required
              />
            </div>
            ...
            <div className="edit-field">
              ...
              <select
                ...
                style={{ padding: "8px 12px", height: "42px", borderRadius: "8px", border: "1.5px solid var(--green-light)" }}
              >
            ...
            {/* Unit */}
            <div className="edit-field">
              <label className="edit-label">Đơn vị tính *</label>
              <input
                className="dash-input"
                value={unit}
                onChange={(e) => setUnit(e.target.value)}
                placeholder="Ví dụ: kg, gói 250g, bó, hũ..."
                required
              />
            </div>
            ...
            {/* Origin */}
            <div className="edit-field">
              <label className="edit-label">Xuất xứ *</label>
              <input
                className="dash-input"
                value={origin}
                onChange={(e) => setOrigin(e.target.value)}
                placeholder="Ví dụ: Tỉnh Lâm Đồng, Tỉnh Sóc Trăng..."
                required
              />
            </div>
          ...
          <div className="edit-field">
            ...
            <textarea
              ...
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Mô tả quy trình canh tác, độ tươi ngon và hướng dẫn bảo quản..."
              required
            />
            <span className="edit-char-count">{description.length} ký tự</span>
          </div>
...
export default function ShopDashboard() {
  ...
  function handleAddProduct(newProduct) {
    ...
    addToast(`Đã thêm sản phẩm "${newProduct.name}" thành công!`, "✨");
  }
